...
2. Заменяет 7 плейсхолдеров (`vladimirbodnaryuk`, `/Users/admin/GIT` и др.)
...
1. Замените `vladimirbodnaryuk` на ваш GitHub username во всех файлах
2. Замените `/Users/admin/GIT` на путь к рабочей директории (напр. `~/Github`)
3. Замените `/Users/admin` на домашнюю директорию (значение `$HOME`)
4. Замените `-Users-admin-GIT` на путь через дефисы (напр. для `~/Github` → `-Users-yourname-Github`)
