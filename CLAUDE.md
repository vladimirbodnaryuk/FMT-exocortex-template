...
### Работа с транскриптами встреч

> При наличии и резюме (summary), и полнотекстовой расшифровки — **приоритет полнотекстовой расшифровке**. Самостоятельно формировать резюме из полного текста, а не полагаться на автоматическое.
