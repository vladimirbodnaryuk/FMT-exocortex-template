...
| Репо | Путь | Описание |
|------|------|----------|
| DS-ABF | `/Users/admin/GIT/DS-ABF/` | АБФ — финансовая компания (ФК), учредитель АМ (Александр Михайлович) |
| DS-PLH | `/Users/admin/GIT/DS-PLH/` | Клиентский проект Племхоз |
| DS-IWE | `/Users/admin/GIT/DS-IWE/` | Отдельный проект по экзокортексу: кейсы, артефакты, примеры использования |
| FPF | `/Users/admin/GIT/FPF/` | Внешний base-источник принципов и форматов (READ-ONLY) |

## Pack-репо

| Pack | Путь |
|------|------|
| PACK-personal | Личностное развитие (здоровье, анализы, метрики) | `/Users/admin/GIT/PACK-personal/` |
