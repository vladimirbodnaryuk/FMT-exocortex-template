...
- **WeekPlan:** /mnt/d/Git/DS-strategy/current/WeekPlan W*.md
...
git -C /mnt/d/Git/<repo> log --since="last monday 00:00" --until="today 00:00" --oneline --no-merges
```
...
> Проверь: существует ли директория `/mnt/d/Git/DS-Knowledge-Index-your-username/`?
> Если нет — пропусти шаг 6 полностью.

1. Переключись на **роль Автора (R4)** и на основе WeekReport сформируй пост для клуба.

   **Обязательно прочитай** `/mnt/d/Git/DS-Knowledge-Index-your-username/CLAUDE.md` — полные инструкции роли Автора:
...
2. Создай файл `/mnt/d/Git/DS-Knowledge-Index-your-username/docs/{YYYY}/{YYYY-MM-DD}-week-review-w{N}.md`
...
4. Обнови `/mnt/d/Git/DS-Knowledge-Index-your-username/docs/README.md` — добавь строку в начало текущего месяца
