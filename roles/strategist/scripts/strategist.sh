...
notify_telegram() {
    local scenario="$1"
    "/mnt/d/Git/FMT-exocortex-template/roles/synchronizer/scripts/notify.sh" strategist "$scenario" >> "$LOG_FILE" 2>&1 || true
}
...
case "$1" in
    ...
    "week-review")
        ...
        KI_REPO="/mnt/d/Git/DS-Knowledge-Index-your-username"
